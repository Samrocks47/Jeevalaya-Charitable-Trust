...
showCardDetails( cardWrapper , cardData) {
    ...
    if (!modal) {
        ...
        modal.innerHTML = `
            <div class="card-popup">
                ...
                <div class="wallet-slot"></div>

                <img class="popup-card">
        ...
        modal.querySelector(".close-card").onclick = () => {
    ...
    // Start with the carousel image
    const originalImg = cardWrapper.querySelector(".card-image");

popupCard.src = originalImg.src;

    popupCard.style.animation = "none";
    popupCard.offsetHeight;
    popupCard.style.animation = "pullCard .6s ease forwards";

    modal.classList.add("active");

    // Reveal another image after the pull animation
    setTimeout(() => {

        popupCard.style.opacity = 0;

        setTimeout(() => {
            popupCard.src = cardData.detail;
...
const cards = [
  {
    front: "images/Component 30.png",
    detail: "images/Component 34.png"
  },
  {
    front: "images/Component 31.png",
    detail: "images/Component 35.png"
  },
  {
    front: "images/Component 32.png",
    detail: "images/Component 36.png"
  },
  {
    front: "images/Component 33.png",
    detail: "images/Component 37.png"
  }
];
  ...
  asciiCard.appendChild(matrixCanvas);

this.startMatrixRain(matrixCanvas);
    wrapper.appendChild(normalCard);
    wrapper.appendChild(asciiCard);
    wrapper.addEventListener("click", () => {
    this.showCardDetails(wrapper, cardData);
});
